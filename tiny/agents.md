// TinyTime Cheatsheet. Important: Only use the following functions and features. Implementation: lib/core/tiny/
// enum PlayerRole: Knight, Archer	// Enums need to be defined outside of classes
...
//          pixels[vector] = color	// Set pixel at position between {0,0} and {192,144} to color between 0 and 15
