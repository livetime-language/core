...
// File: classes/app.l	// Create file "classes/app.l" to declare class app. Lowercase name makes it static. Access members with app.with app.players, app.start, etc.
