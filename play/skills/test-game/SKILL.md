...
# For each rule
1. Write as many unit tests as needed to verify every aspect of the rule. Make sure you test every variation and every edge case of the rule. The tests should use these functions to simulate user input: click, drag, hover, moveLeftStickTo, etc. For example:
